...
<<<<<<< Updated upstream
    directory = "J:\groups\udotfy19\BYU-UDOT-Highway-Safety-Data-Prep-and-Report-Compiler\Report_Compiler_Code\VBA"
=======
    directory = ActiveWorkbook.path & "\Report_Compiler_Code\VBA"
>>>>>>> Stashed changes
    count = 0
