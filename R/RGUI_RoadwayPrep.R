...
IC <- IC %>%
  mutate(
    ...
    MEV_2020 = ifelse(Int_ID == 903 & MEV_2020 == 0, 26.44, MEV_2020),
    MEV_2019 = ifelse(Int_ID == 903 & MEV_2019 == 0, 25.98, MEV_2019),
    MEV_2018 = ifelse(Int_ID == 903 & MEV_2018 == 0, 24.08, MEV_2018),
    MEV_2017 = ifelse(Int_ID == 903 & MEV_2017 == 0, 25.24, MEV_2017),
    MEV_2016 = ifelse(Int_ID == 903 & MEV_2016 == 0, 24.01, MEV_2016),
    ...
    MEV_2020 = ifelse(Int_ID == 4017 & MEV_2020 == 0, 4.13, MEV_2020),
    MEV_2019 = ifelse(Int_ID == 4017 & MEV_2019 == 0, 4.74, MEV_2019),
    MEV_2018 = ifelse(Int_ID == 4017 & MEV_2018 == 0, 4.70, MEV_2018),
    MEV_2017 = ifelse(Int_ID == 4017 & MEV_2017 == 0, 4.29, MEV_2017),
    MEV_2016 = ifelse(Int_ID == 4017 & MEV_2016 == 0, 3.95, MEV_2016),
    ...
    MEV_2020 = ifelse(Int_ID == 4022 & MEV_2020 != 0, 5.69, MEV_2020),
    MEV_2019 = ifelse(Int_ID == 4022 & MEV_2019 != 0, 6.49, MEV_2019),
    MEV_2018 = ifelse(Int_ID == 4022 & MEV_2018 != 0, 6.43, MEV_2018),
    MEV_2017 = ifelse(Int_ID == 4022 & MEV_2017 != 0, 6.35, MEV_2017),
    MEV_2016 = ifelse(Int_ID == 4022 & MEV_2016 == 0, 6.19, MEV_2016),
    ...
    MEV_2020 = ifelse(Int_ID == 4030 & MEV_2020 == 0, 10.89, MEV_2020),
    MEV_2019 = ifelse(Int_ID == 4030 & MEV_2019 == 0, 12.46, MEV_2019),
    MEV_2018 = ifelse(Int_ID == 4030 & MEV_2018 == 0, 12.34, MEV_2018),
    MEV_2017 = ifelse(Int_ID == 4030 & MEV_2017 == 0, 5.28, MEV_2017),
    MEV_2016 = ifelse(Int_ID == 4030 & MEV_2016 == 0, 5.15, MEV_2016),
    ...
    MEV_2020 = ifelse(Int_ID == 4031 & MEV_2020 != 0, 10.89, MEV_2020),
    MEV_2019 = ifelse(Int_ID == 4031 & MEV_2019 != 0, 12.46, MEV_2019),
    MEV_2018 = ifelse(Int_ID == 4031 & MEV_2018 != 0, 12.34, MEV_2018),
    MEV_2017 = ifelse(Int_ID == 4031 & MEV_2017 != 0, 5.28, MEV_2017),
    MEV_2016 = ifelse(Int_ID == 4031 & MEV_2016 == 0, 5.15, MEV_2016),
