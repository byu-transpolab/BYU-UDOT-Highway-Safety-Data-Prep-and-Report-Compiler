...
IC <- IC %>%
  mutate(
    IntVol2020 = ifelse(Int_ID == 903 & is.zero(IntVol2020), 72445, IntVol2020),
    IntVol2019 = ifelse(Int_ID == 903 & is.na(IntVol2019), 71169, IntVol2019),
    IntVol2018 = ifelse(Int_ID == 903 & is.na(IntVol2018), 65980, IntVol2018),
    IntVol2017 = ifelse(Int_ID == 903 & is.na(IntVol2017), 69160, IntVol2017),
    IntVol2016 = ifelse(Int_ID == 903 & is.na(IntVol2016), 65768, IntVol2016),
    MEV_2020 = ifelse(Int_ID == 903 & is.na(MEV_2020), 26.44, MEV_2020),
    MEV_2019 = ifelse(Int_ID == 903 & is.na(MEV_2019), 25.98, MEV_2019),
    MEV_2018 = ifelse(Int_ID == 903 & is.na(MEV_2018), 24.08, MEV_2018),
    MEV_2017 = ifelse(Int_ID == 903 & is.na(MEV_2017), 25.24, MEV_2017),
    MEV_2016 = ifelse(Int_ID == 903 & is.na(MEV_2016), 24.01, MEV_2016),
    
    IntVol2020 = ifelse(Int_ID == 4017 & is.na(IntVol2020), 11305, IntVol2020),
    IntVol2019 = ifelse(Int_ID == 4017 & is.na(IntVol2019), 12994, IntVol2019),
    IntVol2018 = ifelse(Int_ID == 4017 & is.na(IntVol2018), 12865, IntVol2018),
    IntVol2017 = ifelse(Int_ID == 4017 & is.na(IntVol2017), 11759, IntVol2017),
    IntVol2016 = ifelse(Int_ID == 4017 & is.na(IntVol2016), 10809, IntVol2016),
    MEV_2020 = ifelse(Int_ID == 4017 & is.na(MEV_2020), 4.13, MEV_2020),
    MEV_2019 = ifelse(Int_ID == 4017 & is.na(MEV_2019), 4.74, MEV_2019),
    MEV_2018 = ifelse(Int_ID == 4017 & is.na(MEV_2018), 4.70, MEV_2018),
    MEV_2017 = ifelse(Int_ID == 4017 & is.na(MEV_2017), 4.29, MEV_2017),
    MEV_2016 = ifelse(Int_ID == 4017 & is.na(MEV_2016), 3.95, MEV_2016),
    
    IntVol2020 = ifelse(Int_ID == 4022 & is.na(IntVol2020), 15593, IntVol2020),
    IntVol2019 = ifelse(Int_ID == 4022 & is.na(IntVol2019), 17774, IntVol2019),
    IntVol2018 = ifelse(Int_ID == 4022 & is.na(IntVol2018), 17608, IntVol2018),
    IntVol2017 = ifelse(Int_ID == 4022 & is.na(IntVol2017), 17395, IntVol2017),
    IntVol2016 = ifelse(Int_ID == 4022 & is.na(IntVol2016), 16964, IntVol2016),
    MEV_2020 = ifelse(Int_ID == 4022 & is.na(MEV_2020), 5.69, MEV_2020),
    MEV_2019 = ifelse(Int_ID == 4022 & is.na(MEV_2019), 6.49, MEV_2019),
    MEV_2018 = ifelse(Int_ID == 4022 & is.na(MEV_2018), 6.43, MEV_2018),
    MEV_2017 = ifelse(Int_ID == 4022 & is.na(MEV_2017), 6.35, MEV_2017),
    MEV_2016 = ifelse(Int_ID == 4022 & is.na(MEV_2016), 6.19, MEV_2016),
    
    IntVol2020 = ifelse(Int_ID == 4030 & is.na(IntVol2020), 29839, IntVol2020),
    IntVol2019 = ifelse(Int_ID == 4030 & is.na(IntVol2019), 34148, IntVol2019),
    IntVol2018 = ifelse(Int_ID == 4030 & is.na(IntVol2018), 33820, IntVol2018),
    IntVol2017 = ifelse(Int_ID == 4030 & is.na(IntVol2017), 14473, IntVol2017),
    IntVol2016 = ifelse(Int_ID == 4030 & is.na(IntVol2016), 14119, IntVol2016),
    MEV_2020 = ifelse(Int_ID == 4030 & is.na(MEV_2020), 10.89, MEV_2020),
    MEV_2019 = ifelse(Int_ID == 4030 & is.na(MEV_2019), 12.46, MEV_2019),
    MEV_2018 = ifelse(Int_ID == 4030 & is.na(MEV_2018), 12.34, MEV_2018),
    MEV_2017 = ifelse(Int_ID == 4030 & is.na(MEV_2017), 5.28, MEV_2017),
    MEV_2016 = ifelse(Int_ID == 4030 & is.na(MEV_2016), 5.15, MEV_2016),
    
    IntVol2020 = ifelse(Int_ID == 4031 & is.na(IntVol2020), 29839, IntVol2020),
    IntVol2019 = ifelse(Int_ID == 4031 & is.na(IntVol2019), 34148, IntVol2019),
    IntVol2018 = ifelse(Int_ID == 4031 & is.na(IntVol2018), 33820, IntVol2018),
    IntVol2017 = ifelse(Int_ID == 4031 & is.na(IntVol2017), 14473, IntVol2017),
    IntVol2016 = ifelse(Int_ID == 4031 & is.na(IntVol2016), 14119, IntVol2016),
    MEV_2020 = ifelse(Int_ID == 4031 & is.na(MEV_2020), 10.89, MEV_2020),
    MEV_2019 = ifelse(Int_ID == 4031 & is.na(MEV_2019), 12.46, MEV_2019),
    MEV_2018 = ifelse(Int_ID == 4031 & is.na(MEV_2018), 12.34, MEV_2018),
    MEV_2017 = ifelse(Int_ID == 4031 & is.na(MEV_2017), 5.28, MEV_2017),
    MEV_2016 = ifelse(Int_ID == 4031 & is.na(MEV_2016), 5.15, MEV_2016),
    
    MAX_THRU_CNT = if_else(Int_ID == 4056 & is.zero(MAX_THRU_CNT), 2, MAX_THRU_CNT),
    MAX_THRU_WDTH = if_else(Int_ID == 4056 & is.zero(MAX_THRU_WDTH), 12, MAX_THRU_WDTH),
    
    MAX_THRU_CNT = if_else(Int_ID == 4058 & is.zero(MAX_THRU_CNT), 2, MAX_THRU_CNT),
    MAX_THRU_WDTH = if_else(Int_ID == 4058 & is.zero(MAX_THRU_WDTH), 12, MAX_THRU_WDTH),
    ...
    IntVol2016 = ifelse(Int_ID == 7613 & is.zero(IntVol2016), 17833.667, IntVol2016),
    MEV_2016 = ifelse(Int_ID == 7613 & is.zero(MEV_2016), 6.509, MEV_2016),
    
    IntVol2016 = ifelse(Int_ID == 7614 & is.zero(IntVol2016), 17833.667, IntVol2016),
    MEV_2016 = ifelse(Int_ID == 7614 & is.zero(MEV_2016), 6.509, MEV_2016),
