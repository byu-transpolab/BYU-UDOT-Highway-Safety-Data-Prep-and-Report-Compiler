...
for (i in 1:nrow(intersection)){
  ...
  if(!is.na(speed_row0[1])){
    intersection[["INT_RT_0_SL"]][i] <- speed_full$SPEED_LIMIT[speed_row0[1]]}
  if(!is.na(speed_row1[1])){
    intersection[["INT_RT_1_SL"]][i] <- speed_full$SPEED_LIMIT[speed_row1[1]]}
  if(!is.na(speed_row2[1])){
    intersection[["INT_RT_2_SL"]][i] <- speed_full$SPEED_LIMIT[speed_row2[1]]}
  if(!is.na(speed_row3[1])){
    intersection[["INT_RT_3_SL"]][i] <- speed_full$SPEED_LIMIT[speed_row3[1]]}
  if(!is.na(speed_row4[1])){
    intersection[["INT_RT_4_SL"]][i] <- speed_full$SPEED_LIMIT[speed_row4[1]]}
}
